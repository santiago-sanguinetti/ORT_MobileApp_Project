...
var capacitorExports = (function (e) {
    ...
    (e.ExceptionCode = void 0),
        ((i = e.ExceptionCode || (e.ExceptionCode = {})).Unimplemented =
            "UNIMPLEMENTED"),
    ...
    const s = (t) => {
            ...
            const l = t.CapacitorCustomPlatform || null,
                ...
                p =
                    (null === (n = null == u ? void 0 : u.currentPlatform) ||
                    void 0 === n
                        ? void 0
                        : n.getPlatform) ||
                    (() =>
                ...
                m =
                    (null === (r = null == u ? void 0 : u.currentPlatform) ||
                    void 0 === r
                        ? void 0
                        : r.isNativePlatform) || (() => "web" !== p()),
                f =
                    (null === (i = null == u ? void 0 : u.currentPlatform) ||
                    void 0 === i
                        ? void 0
                        : i.isPluginAvailable) ||
                    ((e) => {
                        const t = w.get(e);
                        return (
                            !!(null == t ? void 0 : t.platforms.has(p())) ||
                            !!g(e)
                        );
                    }),
                g =
                    (null === (s = null == u ? void 0 : u.currentPlatform) ||
                    void 0 === s
                        ? void 0
                        : s.getPluginHeader) ||
                    ((e) => {
                ...
                w = new Map(),
                h =
                    (null === (a = null == u ? void 0 : u.currentPlatform) ||
                    void 0 === a
                        ? void 0
                        : a.registerPlugin) ||
                    ((t, n = {}) => {
                        ...
                        if (r)
                            return (
                                console.warn(
                                    `Capacitor plugin "${t}" already registered. Cannot register plugins twice.`
                                ),
                                r.proxy
                            );
                        const i = p(),
                                            ...
                                            if (!s) {
                                                if (n)
                                                    return null ===
                                                        ...
                                                        : l.bind(n);
                                                throw new o(
                                                    `"${t}" plugin is not implemented on ${i}`,
            ...
            return (
                c.convertFileSrc || (c.convertFileSrc = (e) => e),
                (c.getPlatform = p),
                (c.handleError = (e) => t.console.error(e)),
                (c.isNativePlatform = m),
                (c.isPluginAvailable = f),
                (c.pluginMethodNoop = (e, t, n) =>
                    Promise.reject(
    ...
    const g = l("CapacitorCookies", { web: () => new f() }),
        w = (e, t = {}) => {
            ...
            if ("string" == typeof e.data) n.body = e.data;
                ...
                (r.includes("application/json") || "object" == typeof e.data) &&
    ...
    class h extends d {
        async request(e) {
            ...
            return (
                ...
                { data: s, headers: c, status: i.status, url: i.url }
            );
        }
        async get(e) {
            return this.request(
    ...
    const v = l("CapacitorHttp", { web: () => new h() });
    return (
        (e.Capacitor = a),
        (e.CapacitorCookies = g),
        (e.CapacitorException = o),
        (e.CapacitorHttp = v),
        (e.CapacitorPlatforms = t),
        (e.Plugins = c),
        (e.WebPlugin = d),
        (e.WebView = u),
        (e.addPlatform = n),
        ...
        (e.registerWebPlugin = (e) =>
            ((e, t) => {
                ...
                console.warn(
                    `Capacitor plugin "${r.name}" is using the deprecated "registerWebPlugin()" function`
                ),
                    (i[r.name] &&
                        !(null === (n = null == r ? void 0 : r.platforms) ||
                        void 0 === n
                            ? void 0
                            : n.includes(e.getPlatform()))) ||
                        (i[r.name] = t);
            })(a, e)),
        (e.setPlatform = r),
